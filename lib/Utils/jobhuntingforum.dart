...
class jobhuntingforum extends StatefulWidget {
  // const jobhunting({ Key? key }) : super(key: key);

  @override
  State<jobhuntingforum> createState() => _jobhuntingforumState();
}

class _jobhuntingforumState extends State<jobhuntingforum> {
        ...
        child: Column(
          children: [
            ...
            BoxWidget(
              ...
              contents: jobhuntingforunmcontents,
            )),
          ],
        ),
      ),
